...
def train():
    ...
    init_del_w1 = []
    init_del_w2 = []
    im_x = cv2.imread('lab_7/train/x.jpg', cv2.IMREAD_GRAYSCALE)
    im_o = cv2.imread('lab_7/train/o.jpg', cv2.IMREAD_GRAYSCALE)
    ...
    with open('lab_7/weights/x_o.pkl', 'wb') as output:
